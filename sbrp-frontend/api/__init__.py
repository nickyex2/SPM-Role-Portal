...
# get skill by id
@app.route("/api/skills/getOne/<int:skill_id>")
...
@app.route("/api/skills/getMulti", methods=['POST'])
def find_by_ids():
...
# # create new skill
# @app.route("/api/skills/create/<int:skill_id>", methods=['POST'])
...
# @app.route("/api/skills/update/<int:skill_id>", methods=['PUT'])
