...
class RoleApplicationIntegrationTests(unittest.TestCase):
    print("Running role application API tests...")
    def setUp(self):
        self.base_url = os.environ.get("BASE_URL") + "/api/role"
    ...
    def test_create_role_application(self):
        ...
        response = requests.post(f'{self.base_url}/createRoleApplication', json=data)
    ...
    def test_get_all_role_applications(self):
        ...
        response = requests.get(f'{self.base_url}/getAllRoleApplications')
    ...
    def test_get_role_application_by_role_listing(self):
        ...
        role_listing_id = 1
        response = requests.get(f'{self.base_url}/getRoleApplicationsListing/{role_listing_id}')
        self.assertEqual(response.status_code, 200)
    ...
    def test_get_role_application_by_staff(self):
        ...
        staff_id = 1
        response = requests.get(f'{self.base_url}/getRoleApplicationsStaff/{staff_id}')
        self.assertEqual(response.status_code, 200)
        self.assertTrue(len(response.json()['data']['role_applications']) > 0)
    ...
    def test_get_role_application_by_role_listing_and_staff(self):
        ...
        role_listing_id = 1
        staff_id = 1
        response = requests.get(f'{self.base_url}/getRoleApplication/{role_listing_id}/{staff_id}')
        self.assertEqual(response.status_code, 200)
    ...
    def test_update_role_application(self):
        ...
        response = requests.put(f'{self.base_url}/updateRoleApplication/{role_app_id}', json=data)
        self.assertEqual(response.status_code, 200)
    ...
    def test_delete_role_application(self):
        ...
        response = requests.delete(f'{self.base_url}/deleteRoleApplication/{role_app_id}')
        self.assertEqual(response.status_code, 200)
